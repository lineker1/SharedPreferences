package me.udemy.aluno.sharedpreferences;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: Código " + sharedPreferences.getInt("codigoProduto",
                -1));

        Log.d(TAG, "onCreate: Preço " + sharedPreferences.getFloat("precoProduto",
                -1.0f));
